...
class Parser(argparse.ArgumentParser):
    def __init__(self):
        ...
        # model
        self.add_argument('-ns', '--n-samples', type=int, default=3, help='(5-30) number of model instances in SVGD')
        ...
        self.add_argument('--lr', type=float, default=1e-5, help='learnign rate')
        self.add_argument('--lr-noise', type=float, default=5e-7, help='learnign rate')
        ...
        self.add_argument('--noise', type=float, default=1e-4, help='noise in prior')
